...
class HomePage {
    ...
    visitHomePage() {
        // Rotas
        cy.intercept('POST', 'https://fiathuboffers.fcalatam.com.br/offers/search').as('postOffersSearch')
        cy.intercept('POST', 'https://bam.nr-data.net/1/**&ref=https://autoforce-academy.pilotodetestes.com.br/ddm-fiat-v2-dois**').as('postBam')
